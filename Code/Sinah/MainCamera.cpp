...
// Sets default values
AMainCamera::AMainCamera() : Super(), ZoomMin(20.f), ZoomMax(65.f), XMin(-60.f), XMax(50.f), YMin(-55.f), YMax(55.f), DefaultZoom(35.f), Angle(40.f), MoveScale(250.f), ZoomScale(160.f), CurrentLocation(0.f, 0.f, 0.f), Right(0.f, 0.f, 0.f), Forward(0.f, 0.f, 0.f)
{
