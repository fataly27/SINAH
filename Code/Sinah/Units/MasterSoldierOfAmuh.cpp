...
#include "Sinah.h"
#include "MasterSoldierOfAmuh.h"

AMasterSoldierOfAmuh::AMasterSoldierOfAmuh() : Super()
{
	Name = FName(TEXT("Master soldier of Amuh"));
...
float AMasterSoldierOfAmuh::GetSize()
{
	return 28.f;
}
unsigned int AMasterSoldierOfAmuh::GetLifeBarWidth()
{
	return 500;
}