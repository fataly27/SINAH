...
#include "Sinah.h"
#include "SpecialisedSoldierOfLorthemid.h"

ASpecialisedSoldierOfLorthemid::ASpecialisedSoldierOfLorthemid() : Super()
{
	Name = FName(TEXT("Specialised soldier of Lorthemid"));

	DefaultMaxLife = 200;
	DefaultPhysicAttack = 6;
	DefaultMagicAttack = 0;
	DefaultPhysicDefense = 4;
...
float ASpecialisedSoldierOfLorthemid::GetSize()
{
	return 28.f;
}
unsigned int ASpecialisedSoldierOfLorthemid::GetLifeBarWidth()
{
	return 500;
}