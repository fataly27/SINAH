...
#include "Sinah.h"
#include "MasterSoldierOfZhark.h"

AMasterSoldierOfZhark::AMasterSoldierOfZhark() : Super()
{
	Name = FName(TEXT("Master soldier of Zhark"));

	DefaultMaxLife = 400;
	DefaultPhysicAttack = 7;
	DefaultMagicAttack = 10;
...
float AMasterSoldierOfZhark::GetSize()
{
	return 28.f;
}
unsigned int AMasterSoldierOfZhark::GetLifeBarWidth()
{
	return 500;
}