...
#include "Sinah.h"
#include "MasterSoldierOfHovanion.h"

AMasterSoldierOfHovanion::AMasterSoldierOfHovanion() : Super()
{
	Name = FName(TEXT("Master soldier of Hovanion"));

	DefaultMaxLife = 400;
	DefaultPhysicAttack = 7;
	DefaultMagicAttack = 7;
	DefaultPhysicDefense = 4;
	DefaultMagicDefense = 7;
	DefaultSpeed = 4.f;
...
float AMasterSoldierOfHovanion::GetSize()
{
	return 28.f;
}
unsigned int AMasterSoldierOfHovanion::GetLifeBarWidth()
{
	return 500;
}