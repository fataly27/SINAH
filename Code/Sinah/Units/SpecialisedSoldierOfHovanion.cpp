...
#include "Sinah.h"
#include "SpecialisedSoldierOfHovanion.h"

ASpecialisedSoldierOfHovanion::ASpecialisedSoldierOfHovanion() : Super()
{
	Name = FName(TEXT(" Specialised soldier of Hovanion"));
...
float ASpecialisedSoldierOfHovanion::GetSize()
{
	return 28.f;
}
unsigned int ASpecialisedSoldierOfHovanion::GetLifeBarWidth()
{
	return 500;
}