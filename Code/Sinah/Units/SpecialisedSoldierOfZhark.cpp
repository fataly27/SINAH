...
#include "Sinah.h"
#include "SpecialisedSoldierOfZhark.h"

ASpecialisedSoldierOfZhark::ASpecialisedSoldierOfZhark() : Super()
{
	Name = FName(TEXT("Specialised soldier of Zhark"));

	DefaultMaxLife = 200;
	DefaultPhysicAttack = 7;
	DefaultMagicAttack = 2;
	DefaultPhysicDefense = 1;
...
float ASpecialisedSoldierOfZhark::GetSize()
{
	return 28.f;
}
unsigned int ASpecialisedSoldierOfZhark::GetLifeBarWidth()
{
	return 500;
}